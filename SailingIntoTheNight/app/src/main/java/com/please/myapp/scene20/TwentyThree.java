...
public class TwentyThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TwentyThree.this, TwentyFour.class);
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn_prev.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(TwentyThree.this, TwentyTwo.class);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                });
    ...
    public void sv(){
        ...
        editor.putInt(svbt,R.layout.activity_twenty_three);
        editor.commit();
    }
}
