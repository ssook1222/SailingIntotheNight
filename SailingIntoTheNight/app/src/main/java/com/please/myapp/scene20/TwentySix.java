...
public class TwentySix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TwentySix.this, TwentySeven.class);
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn_prev.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(TwentySix.this, TwentyFive.class);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                });
    ...
    public void sv(){
        ...
        editor.putInt(svbt,R.layout.activity_twenty_six);
        editor.commit();
    }
}
