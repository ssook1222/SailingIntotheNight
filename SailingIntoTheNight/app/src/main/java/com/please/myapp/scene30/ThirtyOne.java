...
public class ThirtyOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ThirtyOne.this, ThirtyTwo.class);
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn_prev.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ThirtyOne.this, TwentynineEight.class);
                        startActivity(intent);
    ...
    public void sv(){
        ...
        editor.putInt(svbt,R.layout.activity_thirty_one);
        editor.commit();
    }
}
