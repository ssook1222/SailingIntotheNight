...
public class TwentyEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkIt == true){
                    Intent intent = new Intent(TwentyEight.this, TwentyNine.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                }
                else if (checkIt==false){
                    Intent intent = new Intent(TwentyEight.this, TwentyTen.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                }
            }
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn_prev.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(TwentyEight.this, TwentySeven.class);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                });
    ...
    public void sv(){
        ...
        editor.putInt(svbt,R.layout.activity_twenty_eight);
        editor.commit();
    }
}
